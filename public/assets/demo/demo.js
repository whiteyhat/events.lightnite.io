  ...
  showSwal: function (type) {
    if (type == 'basic') {
      ...
      swal({
        ...
        swal({
          title: 'Deleted!',
          text: 'Your key(s) have been deleted.',
          type: 'success',
          confirmButtonClass: 'btn btn-success',
          buttonsStyling: false
        })
      ...
      swal({
        ...
        buttonsStyling: false,
        confirmButtonClass: 'btn btn-success',
        html: '<select class="selectpicker" data-size="7" data-style="btn btn-primary" title="Single Select"><option disabled selected>Invoices</option><option value="2">Read-Only</option><option value="3">Withdrawals</option></select>'
